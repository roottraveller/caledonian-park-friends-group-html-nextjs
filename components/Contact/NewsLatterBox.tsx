    ...
    return (
        ...
        >
            ...
            <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
                Join our dedicated team at Caledonian Park Friends Group, committed to preserving and enhancing
                the natural beauty of one of London's cherished treasures, Caledonian Park. As we endeavor to create a greener
                and more sustainable future for the community, we are seeking passionate individuals to work with us in this noble
                endeavor.
                <br/>
                <br/>
                Whether you are an environmental enthusiast, an expert in park management, or simply wish to contribute
                your skills and time to a meaningful cause, we welcome you to be part of our mission. Together, we can make a lasting
                impact, nurturing this green oasis in the heart of London. Join us in safeguarding the natural wonders of Caledonian Park, where
                your efforts can truly make a difference.
            </p>

            <form action="https://docs.google.com/forms/d/e/1FAIpQLSdgg8CE52j2UQH8Lh1RyuZghuY8_lg63_fk2_3942JEXgYydw/viewform?usp=sf_link" method="get" target="_blank">
